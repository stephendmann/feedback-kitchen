...
> **Planned.** Letting Feedback Kitchen offer a save destination directly is carded as FK-45, and a fuller design in which a scorer works from a folder you nominate is recorded as decision D6. Neither has shipped. Until one does, the browser setting above is the only route.
...
*Maintenance: `MANUAL-MAINTENANCE.md` records which parts of this manual each area of the application owns, and the review that runs when any of them changes.*
