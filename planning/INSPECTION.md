...
- **Remaining to ☑:** Q5 controlled test + Moodle version + anonymous-marking variant check. **Artefact hygiene:** the CSV is real student data — gitignored in place; delete or anonymise once FK-19's fake-data fixture exists.
