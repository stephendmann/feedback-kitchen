...
- **Promoted 2026-06-12:** PR [#22](https://github.com/stephendmann/feedback-kitchen/pull/22) (`fk17-wcag-aa-pass`: 3 code commits + D8 cross-ref docs commit), pre-push sense check GO, WARNs acknowledged (deploy-on-merge; emerald-600→700 brand shift). Awaiting merge.
