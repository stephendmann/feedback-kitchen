...
- **Promoted 2026-06-12:** PR [#24](https://github.com/stephendmann/feedback-kitchen/pull/24) (`fk18-rail-sticky`, single commit, scorer.html only). Awaiting merge — fixes a live production regression, so merge-soon recommended.
